...
export class Blank extends React.Component {
  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      ...
      />
      <View style={styles.View_115_381}>
        <View style={styles.View_115_382} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/3e2f/86b9/5281a7c76f38a61d8fd701667f929c55"
          }}
          style={styles.ImageBackground_115_383}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_115_384}
        />
      </View>
      <View style={styles.View_115_385}>
        <View style={styles.View_I115_385_1_4}>
          <View style={styles.View_I115_385_1_5} />
          <View style={styles.View_I115_385_1_6}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/92a5/0a89/5a75434412dfa946273f700061e75d54"
              }}
              style={styles.ImageBackground_I115_385_1_7}
            />
            <View style={styles.View_I115_385_1_10}>
              <Text style={styles.Text_I115_385_1_10}>know</Text>
            </View>
          </View>
          <ImageBackground
            source={{
            ...
            style={styles.ImageBackground_I115_385_1_11}
          />
        </View>
        <TouchableOpacity
          onPress={() =>
        ...
        >
          <View style={styles.View_I115_385_1_15}>
            <Text style={styles.Text_I115_385_1_15}>Ask the leadership</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() =>
        ...
        >
          <View style={styles.View_I115_385_1_14}>
            <Text style={styles.Text_I115_385_1_14}>
        ...
        >
          <View style={styles.View_I115_385_1_13}>
            <Text style={styles.Text_I115_385_1_13}>Operations</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() =>
        ...
        >
          <View style={styles.View_I115_385_1_12}>
            <Text style={styles.Text_I115_385_1_12}>Sales</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() =>
        ...
        >
          <View style={styles.View_I115_385_82_41}>
            <Text style={styles.Text_I115_385_82_41}>Funzone</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() =>
        ...
        >
          <View style={styles.View_I115_385_20_74}>
            <Text style={styles.Text_I115_385_20_74}>Home</Text>
          </View>
        </TouchableOpacity>
      </View>
      <View style={styles.View_115_386}>
        <Text style={styles.Text_115_386}>QUIZ</Text>
      </View>
      <View style={styles.View_115_387}>
        <Text style={styles.Text_115_387}>
      ...
      <View style={styles.View_115_388}>
        <Text style={styles.Text_115_388}>
          Its a wrong answer, your score is #44
        </Text>
      </View>
      <View style={styles.View_115_389}>
        <Text style={styles.Text_115_389}>Uh-ho!!!!</Text>
      </View>
      <View style={styles.View_115_390}>
        <Text style={styles.Text_115_390}>Rethink Robotics</Text>
      </View>
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_115_391}
      />
      <View style={styles.View_115_392}>
        <Text style={styles.Text_115_392}>Grey Orange</Text>
      </View>
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_115_393}
      />
      <View style={styles.View_115_394}>
        <Text style={styles.Text_115_394}>Locus Robotics</Text>
      </View>
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_115_395}
      />
      <View style={styles.View_115_396}>
        <Text style={styles.Text_115_396}>Hanson Robotics</Text>
      </View>
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_115_397}
      />
      <View style={styles.View_115_398}>
        <Text style={styles.Text_115_398}>
          Biswanath - #48 Sri Vidhya - #48 Chandran - #48 Shruti Ajey - #48
          Sachin - #48
        </Text>
      </View>
      <View style={styles.View_115_399}>
        <Text style={styles.Text_115_399}>LEADERBOARD</Text>
      </View>
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_115_452}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_115_453}
      />
    </ScrollView>
  )
}
